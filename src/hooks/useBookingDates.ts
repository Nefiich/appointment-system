...
export const useBookingDates = (
  ...
  // Keep the calendar on the first bookable month instead of hard-coding a March -> April jump
  ...
  const isDateBlocked = (dateToCheck: Date) => {
    return (
      ...
      blockedDates.some((blockedDate) => isSameDay(blockedDate, dateToCheck))
    )
  }
